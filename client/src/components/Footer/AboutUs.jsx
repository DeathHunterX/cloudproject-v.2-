...
import img1 from "../../images/AboutUs/Member/1.png";
import {
  FaCode,
  FaFacebook,
  FaTwitter,
          ...
          >
            <div className="card">
              ...
              <div className="picture">
                <img
                  src={require("../../images/AboutUs/Member/" +
                    expert.lastName +
                    ".jpg")}
                  alt={`expert-${idx}`}
                  onClick={() => {
                ...
                <div id="01" className="slider__item">
                  <div className="slider__position">
                    ...
                    <div className="slider__card__top">
                        <div className="card__top__title">{data.name}</div>
                        <div className="card__top__position">{data.job}</div>
                    </div>
                    <div className="slider__card__mid">
                        <div className="card__mid__left">
                            <div className="mid__left__title">about me</div>
                            <div className="mid__left__text">{data.abouts}</div>
                        </div>
